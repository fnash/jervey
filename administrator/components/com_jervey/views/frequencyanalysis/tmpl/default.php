...
<fieldset>
    ...
    <table class="adminlist">
        ...
        <th width="158px"><?php echo JText::_('JERVEY_LANG_FREQUENCY'); ?></th>
        <th width="77px"><?php echo JText::_('JERVEY_LANG_SIZE'); ?></th>
    </thead>
    <tbody>
    ...
    "data":{
        ...
        "ticks":[
            <?php
                ...
                echo '['.$i.', "'.JText::_('JERVEY_LANG_NO_ANSWER').'"]';
            ?>
        ]
    }
};
...
<?php // RAW DATA for chart
    ...
    echo 'data['.$i.'] = { label: "'.JText::_('JERVEY_LANG_NO_ANSWER').'",  data: '.$noAnswerSampleSize.'}';
?>
