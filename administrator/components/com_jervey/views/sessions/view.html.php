<?php
/**
 * jervey Component sessions View
 *
 * @version     $Id$
...
class jerveyViewSessions extends JView
{
    function display($tpl = null)
    {
        ...
        // TOOLBAR
  		JerveyToolBarHelper::title( JText::_( 'JERVEY_LANG_ANSWERS' ), 'session.png' );
        ...
        JSubMenuHelper::addEntry( JText::_( 'JERVEY_LANG_ANSWERS' ),       'index.php?option=com_jervey&controller=sessions', true);
