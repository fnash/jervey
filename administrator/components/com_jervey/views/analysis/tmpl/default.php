	...
	<div id="editcell">
		...
		<thead>
			<tr>
                ...
                <th>
					<?php echo JText::_('JERVEY_LANG_NAME'); ?>
                </th>
				<th width="120">
					<?php echo JText::_('JERVEY_LANG_TYPE'); ?>
				</th>
				<th width="120">
					<?php echo JText::_('JERVEY_LANG_SAVE_DATE'); ?>
				</th>
                <th>
					<?php echo JText::_('JERVEY_LANG_SURVEY_TITLE'); ?>
				</th>
                <th width="10">
		...
		<?php
			if ( count($this->analysis)) :
				...
				for ($i = 0, $n = count( $this->analysis ) ; $i < $n ; $i++) :
					...
					$link = JRoute::_( 'index.php?option=com_jervey&controller=analysis&task=viewAnalysis&cid[]='. $row->id );
					?>
				...
				echo '<tr><td colspan="7">' . JText::_('JERVEY_LANG_THERE_ARE_NO_RECORDS') . '</td></tr>' ;
			endif ;
		?>
		</tbody>
