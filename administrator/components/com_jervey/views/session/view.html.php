...
class jerveyViewSession extends JView
{
    function display($tpl = null)
    {
       ...
       JToolBarHelper::title( JText::_( 'JERVEY_LANG_SESSION' ).': <small><small> #' . $session->id .'</small></small>' );
       $bar=& JToolBar::getInstance( 'toolbar' );
       $bar->appendButton( 'link', 'cancel', JText::_('JERVEY_LANG_BACK'), 'index.php?option=com_jervey&amp;controller=sessions' );
