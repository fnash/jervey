...
class jerveyViewSurveys extends JView
{
    function display($tpl = null)
    {
        ...
        // TOOLBAR
  	JerveyToolBarHelper::title( JText::_( 'JERVEY_LANG_SURVEYS' ), 'survey.png' );
	...
	JToolBarHelper::addNewX();
        ...
        JSubMenuHelper::addEntry( JText::_( 'JERVEY_LANG_SURVEYS' ),        'index.php?option=com_jervey&controller=surveys', true);
