<?php
/**
 * jervey Component choose Survey View
 *
 * @version     $Id$
...
class jerveyViewChoosesurvey extends JView
{
    function display($tpl = null)
    {
        ...
        JToolBarHelper::title(   JText::_( 'JERVEY_LANG_CHOOSE_SURVEY' ) );
        ...
        $bar->appendButton( 'standard', 'next', JText::_('JERVEY_LANG_NEXT'), 'selectQuestions', true );
