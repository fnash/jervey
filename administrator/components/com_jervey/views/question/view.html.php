<?php
/**
 * jervey Component question View
 *
 * @version     $Id$
...
class jerveyViewQuestion extends JView
{
    function display($tpl = null)
    {
		...
		$text = $isNew ? JText::_( 'JERVEY_LANG_NEW' ) : JText::_( 'JERVEY_LANG_EDIT' );
  		JToolBarHelper::title(   JText::_( 'JERVEY_LANG_QUESTION' ).': <small><small>[ ' . $text .' ]</small></small>' );
        ...
        if ($question->id == 0) {
            $bar->appendButton( 'link', 'publish', JText::_('JERVEY_LANG_PLACE_IN_SECTION'), 'index.php?option=com_jervey&amp;controller=qs&amp;task=showPlace&amp;id='.$question->id, false );
        }
        else {
            $bar->appendButton( 'Popup', 'publish', JText::_('JERVEY_LANG_PLACE_IN_SECTION'), 'index.php?option=com_jervey&amp;controller=qs&amp;task=showPlace&amp;id='.$question->id, 550, 400 );
        }
        
        $bar->appendButton( 'Popup', 'unpublish', JText::_('JERVEY_LANG_UNPLACE_FROM_SECTION'), 'index.php?option=com_jervey&amp;controller=qs&amp;task=showUnplace&amp;id='.$question->id, 550, 400 );
        $bar->appendButton( 'Popup', 'preview', 'preview', 'index.php?option=com_jervey&amp;controller=questions&amp;tmpl=component&amp;task=preview', 550, 400 );
