	...
	<div id="editcell">
		...
		<thead>
			<tr>
				...
				<th width="320">
					<?php echo JText::_('JERVEY_LANG_SECTION'); ?>
				</th>
				<th>
					<?php echo JText::_('JERVEY_LANG_QUESTIONS'); ?>
				</th>
                <th width="60">
					<?php echo JText::_('JERVEY_LANG_ORDER'); ?>
                    <!-- default task = saveOrder - find it in the end of this template - index.php?option=com_jervey&controller=sections&task=saveOrder -->
                    <a onclick="submitform();" href="#" >
                        <img title="<?php echo JText::_('JERVEY_LANG_SAVE_ORDER'); ?>" alt="<?php echo JText::_('JERVEY_LANG_SAVE_ORDER'); ?>" width="16" height="16" src="components/com_jervey/assets/images/saveorder.png">
                    </a>
				</th>
				<th width="20">
...
<?php
	if ( count($this->sections)) :
		...
		$link = JRoute::_( 'index.php?option=com_jervey&controller=sections&task=edit&cid[]=' . $row->section_id );
        $linkQuestion = JRoute::_( 'index.php?option=com_jervey&controller=questions&task=edit&cid[]=' . $row->question_id );
?>
