<?php
/**
 * jervey Component sections View
 *
 * @version     $Id$
...
class jerveyViewSections extends JView
{
    function display($tpl = null)
    {
        ...
        // TOOLBAR
  		JerveyToolBarHelper::title( JText::_( 'JERVEY_LANG_SECTIONS' ), 'section.png' );
        ...
        JSubMenuHelper::addEntry( JText::_( 'JERVEY_LANG_SECTIONS' ),        'index.php?option=com_jervey&controller=sections', true);
