<?php
/**
 * jervey Component Data Manager Controller
 *
 * @version     $Id$
...
class JerveyControllerDatamanager extends JerveyController
{
    /**
     *
     * @var JModel
    ...
    function exportAnswers()
    {
        ...
        require_once (JPATH_COMPONENT . DS . 'helpers' . DS . 'CsvAnswersHelper.php');

        CsvAnswersHelper::write($answers, $questions, $sessions);
        $file = CsvAnswersHelper::getContent();

        // send csv file
        header('Content-Description: File Transfer');
		header('Content-Type: text/csv') ;
		header('Content-Disposition: attachment; filename=jervey_answers.csv');
