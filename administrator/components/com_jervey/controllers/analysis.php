<?php
/**
 * jervey Component Analysis Controller
 *
 * @version     $Id$
...
class JerveyControllerAnalysis extends JerveyController
{
    /**
     *
     * @var JModel
    ...
    function frequencyAnalysis()
    {
        ...
        if (count($cids) != 1)
        {
            $url = 'index.php?option=com_jervey&controller=analysis&task=selectQuestions&cid[]='.$survey_id;
            $msg = JText::_('JERVEY_LANG_FREQUENCY_WARNING_ONE_SINGLE_QUESTION_MUST_BE_CHECKED');
            $type = 'notice';
    ...
    function crossTabAnalysis()
    {
        ...
        {
            $url = 'index.php?option=com_jervey&controller=analysis&task=selectQuestions&cid[]='.$survey_id;
            $msg = JText::_('JERVEY_LANG_CROSS_TAB_WARNING_TWO_QUESTIONS_MUST_BE_CHECKED');
            $type = 'notice';
    ...
    function snapshot()
    {
        ...
        $this->setRedirect('index.php?option=com_jervey&view=nothing&tmpl=component&redir_type=1');
    }
    ...
    function remove()
    {
        ...
        $url = 'index.php?option=com_jervey&controller=analysis';
