<?php
/**
 * jervey Component surveys Controller
 *
 * @version     $Id$
...
class JerveyControllerSurveys extends JerveyController
{
    /**
     *
     * @var JModel
    ...
    function setAccess()
    {
        ...
        {
            $msg = JText::_('JERVEY_LANG_ERROR_SETTING_ACCESS');
            $type = 'error';
        }

        $url = 'index.php?option=com_jervey&controller=surveys';
    ...
    function setPublished()
    {
        ...
        {
            $msg = JText::_('JERVEY_LANG_ERROR_PUBLICATION_FAILED');
            $type = 'error';
        }
    ...
    function assignUser()
    {
        ...
        $url = 'index.php?option=com_jervey&controller=surveys&task=showUsers&cid[]='.$survey_id;
        ...
        switch ($task)
        {
            case 'assignUser':
                 ...
                 {
                     $msg = JText::_('JERVEY_LANG_ERROR_AFFECTING_USER_TO_SURVEY');
                     $type = 'error';
                 }
                 else
                 {
                     $msg = JText::_('JERVEY_LANG_USER_AFFECTED_TO_SURVEY');
                     $type = 'message';
                 }
                 break;
            ...
            case 'unassignUser':
                ...
                {
                     $msg = JText::_('JERVEY_LANG_ERROR_UNAFFECTING_USER_FROM_SURVEY');
                     $type = 'error';
                }
                else
                {
                     $msg = JText::_('JERVEY_LANG_USER_UNAFFECTED_FROM_SURVEY');
                     $type = 'message';
                }
        }
    ...
    function saveOrder()
    {
        $link = 'index.php?option=com_jervey&controller=surveys';
        ...
        if (is_null($cids))
        {
            $msg = JText::_('JERVEY_LANG_WARNING_NO_CHECKED_SURVEY');
        ...
        foreach ($cids as $survey_id)
        {
            foreach ($ranks[$survey_id] as $section_id => $section_rank)
            {
                ...
                {
                    $msg = JText::_('JERVEY_LANG_ERROR_UPDATING_ORDER');
                    $type = 'error';
                }
            }
        }
        $msg = JText::_('JERVEY_LANG_ORDER_SAVED');
    ...
    function save()
    {
        ...
        {
            $msg = JText::_( 'JERVEY_LANG_RECORD_SAVED' );
            $type = 'message';
        }
        else
        {
            $msg = JText::_( 'JERVEY_LANG_ERROR_SAVING_RECORD' );
            $type = 'error';
        }
        ...
        {
            case 'saveContinue':
                $link = 'index.php?option=com_jervey&controller=surveys&task=edit&cid[]=0';
                break;
            ...
            case 'apply':
                ...
                $link = 'index.php?option=com_jervey&controller=surveys&task=edit&cid[]=' . $id;
                break;
    ...
    function remove()
    {
        ...
        $this->setRedirect( 'index.php?option=com_jervey&controller=surveys', $msg, $type );
    }
    ...
    function authorizeUsers()
    {
        ...
        {
            $msg = JText::_( 'JERVEY_LANG_ERROR_AUTHORIZING_USERS' );
            $type = 'error';
        }
        else
        {
            $msg = JText::_( 'JERVEY_LANG_SUCCESS' );
            $type = 'message';
        }
        $link = 'index.php?option=com_jervey&controller=surveys&task=showUsers&cid[]='.$survey_id;
        $this->setRedirect( $link, $msg, $type );
    }
    ...
    function unauthorizeUsers()
    {
        ...
        {
            $msg = JText::_( 'JERVEY_LANG_ERROR_UNAUTHORIZING_USERS' );
            $type = 'error';
        }
        else
        {
