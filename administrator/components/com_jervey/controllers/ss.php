<?php
/**
 * jervey Component sections surveys è surveys sections Controller
 *
 * @version     $Id$
...
class JerveyControllerSs extends JerveyController
{
    /**
     *
     * @var JModel
    ...
    function showSet()
    {
        ...
        switch ($task)
        {
            case 'showSet':
                ...
                if ($id == 0)
                {
                    $url  = 'index.php?option=com_jervey&controller=surveys&task=edit&cid[]=0';
                    $msg  = JText::_('JERVEY_LANG_WARNING_YOU_MUST_SAVE_THE_SURVEY_BEFORE');
                    $type = 'notice';
