<?php
/**
 * jervey Component sections Controller
 *
 * @version     $Id$
...
class JerveyControllerSections extends JerveyController
{
    /**
     *
     * @var JModel
    ...
    function remove()
    {
        ...
        $this->setRedirect( 'index.php?option=com_jervey&controller=sections', $msg, $type );
    }
    ...
    function save()
    {
        ...
        {
            case 'saveContinue':
                $link = 'index.php?option=com_jervey&controller=sections&task=edit&cid[]=0';
                break;
            ...
            case 'apply':
                ...
                $link = 'index.php?option=com_jervey&controller=sections&task=edit&cid[]=' . $id;
                break;

            case 'save': // save
                $link = 'index.php?option=com_jervey&controller=sections';
        }
    ...
    function saveOrder()
    {
        ...
        if (is_null($cids))
        {
            $msg = JText::_('JERVEY_LANG_WARNING_NO_CHECKED_SECTION');
