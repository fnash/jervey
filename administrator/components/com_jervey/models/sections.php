<?php
/**
 * jervey Component sections Model
 *
 * @version     $Id$
...
class jerveyModelSections extends JModel
{
    /**
     * @var int
     */
    ...
    public function getSectionsWithQuestions()
    {
        if (empty( $this->_data ))
        {
            ...
            '       FROM #__jervey_sections_questions jsq' .
            '       WHERE jsq.section_id = s.id) AS rowspan'.
            ' FROM #__jervey_sections s'.
            '   LEFT JOIN #__jervey_sections_questions sq ON s.id = sq.section_id'.
    ...
    {
        $query = 'DELETE FROM #__jervey_sections_questions'.
        ' WHERE section_id = '. $section_id;
    ...
    {
        $query = 'UPDATE #__jervey_surveys_sections'.
