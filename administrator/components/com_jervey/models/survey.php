...
class jerveyModelSurvey extends JModel
{
    ...
    {
        $query = 'UPDATE #__jervey_users_surveys'.
        ' SET is_active = 0'.
   ...
   public function getQuestionsOfSurvey($survey_id)
    ...
    public function getSessionsOfSurvey($survey_id)
    {
        ...
        '   JOIN #__jervey_users_surveys us ON srvy.id = us.survey_id'.
        '   JOIN #__jervey_sessions sess ON sess.affected_id = us.id'.
