<?php
/**
 * jervey Component Surveys Model
 *
 * @version     $Id$
...
class jerveyModelSurveys extends JModel
{
    /**
     * @var int
     */
    ...
    public function getSurveysWithSections()
    {
        if (empty( $this->_data ))
        {
            $query = 'SELECT srvy.id AS survey_id, srvy.title AS survey,'.
                ...
                '       FROM #__jervey_surveys_sections jss' .
                ...
                '     WHERE s1.id = srvy.id'.
                '     ) AS population'.
                ' FROM #__jervey_surveys srvy'.
                '   LEFT JOIN #__jervey_surveys_sections ss ON srvy.id = ss.survey_id'.
                '   LEFT JOIN #__jervey_sections s ON s.id = ss.section_id'.
    ...
    {
        $query = 'DELETE FROM #__jervey_surveys_sections'.
