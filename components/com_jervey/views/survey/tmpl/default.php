<?php
    ...
    // js
    $jq   = JRoute::_("components/com_jervey/assets/js/validate/lib/jquery.js");
    $vld  = JRoute::_("components/com_jervey/assets/js/validate/lib/jquery.metadata.js");
    $meta = JRoute::_("components/com_jervey/assets/js/validate/jquery.validate.js");    
    // css
    $css = $this->baseurl.'/components/com_jervey/assets/css/survey.css';
    ...
    if ( version_compare( JVERSION, '1.6.0', 'ge' ) ) {
        ...
        $mainframe->addCustomHeadTag ('<link rel="stylesheet" href="'.$css.' type="text/css" media="screen" />');
    }
...
<script type="text/javascript">
  jQuery(document).ready(function($) {
    ...
    $("#jervey_srvy_frm").validate(
        {
            errorContainer: $('div.jervey_warning')
        }
    );
  });
...
<form id="jervey_srvy_frm" name="jervey_survey" method="post" action="index.php">
...
<?php if ($row->is_compulsory): ?>
    <div class="jervey_warning"><?php echo JText::_('THIS_QUESTION_IS_REQUIRED') ?></div>
<?php endif; ?>
